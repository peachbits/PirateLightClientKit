...
public class CompactBlockProcessor {
    ...
    */
    public struct Configuration {
        ...
        public var downloadBatchSize = PirateSDK.DefaultBatchSize
        public var retries = PirateSDK.defaultRetries
        public var maxBackoffInterval = PirateSDK.defaultMaxBackOffInterval
        public var rewindDistance = PirateSDK.defaultRewindDistance
        ...
        public var blockPollInterval: TimeInterval {
            TimeInterval.random(in: PirateSDK.defaultPollInterval / 2 ... PirateSDK.defaultPollInterval * 1.5)
        }
        ...
        public init(cacheDb: URL, dataDb: URL, walletBirthday: BlockHeight, network: PirateNetwork) {
            self.cacheDb = cacheDb
            self.dataDb = dataDb
            self.walletBirthday = walletBirthday
    ...
    */
    ...
    func determineLowerBound(
        ...
        let offset = min(PirateSDK.maxReorgSize, PirateSDK.defaultRewindDistance * (consecutiveErrors + 1))
        return max(errorHeight - offset, walletBirthday - PirateSDK.maxReorgSize)
    }
...
public extension CompactBlockProcessor.Configuration {
    ...
    */
    static func standard(for network: PirateNetwork, walletBirthday: BlockHeight) -> CompactBlockProcessor.Configuration {
