...
discontinuity error on libpiratelc when calling `scan_blocks`. This will have a setback of
...
# 0.17.6-beta
### [#756] 0.17.5-beta updates to libpiratelc 0.2.0 when it shouldn't
...
updates `libpiratelc` to `0.1.1` to fix an error where getting a 
...
# 0.17.0-alpha.5
### point to libpiratelc 0.1.0-beta.3. This fixes an issue spending change notes 
# 0.17.0-alpha.4
### point to libpiratelc 0.1.0-beta.2
